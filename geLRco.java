...
class Gramatica {
	...
	*********************************************************/
	...
	void escribetablaacc2(PrintWriter outputStream){
        TVectorAccion acc;
        TEltoAccion item;
		String str = new String("TEltoAccion[][] bindVars = new TEltoAccion[][]{");
		String cad;
...
public class geLRco {
	static void escribeparser(Gramatica g)  throws IOException {
		...
		try {
			...
			outputStream.println("\tpublic parser(String s){");
			...
			outputStream.println("\t}");
			outputStream.println("\tvoid initablaaccion(){");
